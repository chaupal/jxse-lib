 ...
 */
public abstract class AbstractMap<K,V extends Object> extends java.util.AbstractMap<K,V> {
            ...
            keySet = new AbstractSet<K>() { // from e.e.m.b. (overrides toArray)
                ...
                public Iterator<K> iterator() {
                    return new Iterator<K>() {
                        final Iterator<Map.Entry<K, V>> itr = AbstractMap.this.entrySet().iterator();
                        public boolean hasNext() { return itr.hasNext(); }
                        public K next() { return ((Entry<K,V>)itr.next()).getKey(); }
     ...
     * @since 1.6
     */
    public static class SimpleEntry<K,V extends Object> implements Entry<K,V> {
        private final K key;
        private V value;
     ...
     * @since 1.6
     */
    public static class SimpleImmutableEntry<K,V extends Object> implements Entry<K,V> {
        private final K key;
